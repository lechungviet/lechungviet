...
<body>
    ...
    <div class="container-admin">
        ...
        <div class="container">
                <div class="heding">
                   <span>Thống kê mặt hàng được bán trong ngày</span>
                   <button id="btn-them">
                        <a href="./function/xuatEXcel01.php">Xuất file EX</a>
                    </button></td>
                </div>
                <table id="bang" class="table_boder">
                    ...
                    <tbody>
    <?php
    $sql='SELECT donhang.mamh, mathang.tenmh, sum(donhang.soluong) as "tongsl" FROM donhang INNER JOIN mathang on donhang.mamh=mathang.mamh 
    WHERE donhang.ngaydh=date(now())
