...
<body>
    ...
    <div class="container-admin">
        ...
        <div class="container">
                ...
                <form action="./function/them-hangsx.php" method="post" id="form-themkhoa">
                    <input type="text" name="tennsx" placeholder="Nhập tên nhà sản xuất"> <br> <div class="khoancach"></div>
